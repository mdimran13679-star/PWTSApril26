...
test("Handling multiple windows", async ({page})=>{
    ...
    const page1 = page.waitForEvent("popup") // popup event will appear it will store the value and continue the next step
    // console.log(page1); // returning as a Pending
    ...
    // await page.waitForTimeout(2000) // we do not try to use wait concept in this case i.e., waitForTimeout
    ...
    // await page.bringToFront() // Important - It is a method which brings page to front i.e., active tabs
