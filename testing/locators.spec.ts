...
4. Moving from one sibling to another sibling
  ...
  // - to move from one sibling to another sibling - example for Flipkart About section.
...
// codegen - Code generation - This will also generate you automatically the locators and also 
// automatically the code as well that means test case or test script as well.


// Dynamic table xpath where rows and columns keeps changing upon the refresh
//tr[td[text()='System']]/td[count(//th[text()='CPU (%)']/preceding-sibling::th)+1]

// td stands for table definition, tr stands for table row, th stands for table header

// Either first one or second one becomes, which is identifying our table rows over there in this case.
// //td[text()='Internet Explorer'] - first one 

// //tr[td[text()='Internet Explorer']] - second one

// this becomes your second part. CPU percentage have been calculated over here.
// //th[text()='CPU (%)'] - second part

// inside the XPath, there is a method known as count. it will simply help us in terms of performing the count of an element.
// count(//th[text()='CPU (%)']/preceding-sibling::th)

//tr[td[text()='Internet Explorer']]/td[count(//th[text()='CPU (%)']/preceding-sibling::th)+1]
// td[count(//th[text()='CPU (%)']/preceding-sibling::th)+1] - td[4] // we have to write like this for td[4] = td[count(//th[text()='CPU (%)']/preceding-sibling::th)+1]

// Any one you can write in the below one i.e., Dynamic table xpath where rows and columns keeps changing upon the refresh
//tr[td[text()='Internet Explorer']]/td[count(//th[text()='CPU (%)']/preceding-sibling::th)+1] or 
//tr[td[text()='Internet Explorer']]/td[4] 

// //tr[td[text()='Internet Explorer']]/td[3] // both are equal i.e., Internet Explorer and CPU (%) are matching for this xpath locator
