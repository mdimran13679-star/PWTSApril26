...
// if(text == "login") // "Login" == "login" i.e., upper and lower case are entirely different so it will not execute in this case
// { 
//     console.log("The text value of an element is matching");
// }
...
if(role == "Normal") // if Condition true means "Admin" == "Admin" and else false means "Admin" == "Normal"
{
...
// let browserName = "CHROME".toLowerCase()

// switch(browserName) // switch("chrome")
// {
//     case "chrome".toUpperCase():
//         console.log("Launch the chrome browser - switch");
//         break
//     case "firefox":
//         console.log("Launch the firefox browser - switch");
...
// Syntax for TO(Ternary Operator):
